<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <!-- Lien vers la prospection de pharmacies -->
                    @if(auth()->check())
                        <x-nav-link :href="route('pharmacies.search')" :active="request()->routeIs('pharmacies.search') || request()->routeIs('pharmacies.find')">
                            {{ __('Prospection') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Lien Prospection pour mobile -->
            @if(auth()->check())
                <x-responsive-nav-link :href="route('pharmacies.search')" :active="request()->routeIs('pharmacies.search') || request()->routeIs('pharmacies.find')">
                    {{ __('Prospection') }}
                </x-responsive-nav-link>
            @endif
