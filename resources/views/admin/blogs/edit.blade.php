...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Édition de l'article : {{ $blog->title }}</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    @if($blog->featured_image)
                        <div class="mb-2">
                            <img src="{{ asset($blog->featured_image) }}" alt="{{ $blog->title }}" class="img-thumbnail" style="max-height: 200px;">
                        </div>
                    @endif
